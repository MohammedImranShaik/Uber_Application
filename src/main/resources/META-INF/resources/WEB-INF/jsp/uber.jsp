...
<body>
	<div class="container">
		<h2>Uber Registartion</h2>
		
		<form name="createUber" action="saveUber" method="post">
			<label for="firstName">First Name</label> <input type="text"
				id="firstName" name="firstName" placeholder="Enter the firstName"
				required> <label for="lastName">Last Name</label> <input
				type="text" id="lastName" name="lastName"
				placeholder="Enter the lastName" required> <label
